...
#   pdb.set_trace()
    ...
    asteroid11 = Asteroid('Asteroid9', M_AST*(rnd.randint(1,100)+rnd.uniform(-1,1)), 0, 89.438525,1325.019, -30*AU,32*AU)
    asteroid12= Asteroid('Asteroid10', M_AST*(rnd.randint(1,100)+rnd.uniform(-1,1)),0, 3334.32026,-1982.256, -30*AU,28*AU) 
    
    loop([mercury, venus,sun, earth, mars,jupiter,saturn, uranus, neptune],
         [asteroid1, asteroid2,asteroid3, asteroid4,asteroid5, asteroid6, asteroid7, asteroid8, asteroid9, asteroid10,asteroid11,asteroid12])
